...
public class CardServiceViewModel {
    ...
    public CardServiceViewModel(Long id, CardType cardType, CardProviders cardProviders, Instant expirationDate, String cvvCode, String pinCode, String number, BigDecimal balance, CountryServiceModel currency, boolean isActive) {
        this.id = id;
